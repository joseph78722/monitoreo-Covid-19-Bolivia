...
Titulo_nuevos_casos<- if_else(max(nuevo_nuevos_casos$Nuevos_casos) == tail(nuevo_nuevos_casos$Nuevos_casos, 1), print("Bolivia registra récord de", encoding = "UTF-8"), print("Bolivia registra", encoding = "UTF-8"))

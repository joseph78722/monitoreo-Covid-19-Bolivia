...
Lead_nuevos_casos <- if_else(max(nuevo_nuevos_casos$Nuevos_casos) == tail(nuevo_nuevos_casos$Nuevos_casos, 1), sprintf("Bolivia registra esta joranada un récord de"), sprintf("Bolivia registra esta jornada"))

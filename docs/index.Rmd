...
De este modo, el total de casos confirmados en el país llegó a `r tail(total_Confirmados$Confirmados, 1)` , de los cuales `r tail(activos, 1)` se mantienen activos.
